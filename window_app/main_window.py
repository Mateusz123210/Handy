...
class MyLabel(QLabel, QPushButton):
    ...
    def __init__(self,absolute_path, name, parent=None):
    ...
    def mousePressEvent(self, event) -> None:
        ...
        self.videoWindow.setFixedSize(280, 490)
        self.videoWindow.setWindowFlags(Qt.Tool | Qt. FramelessWindowHint | Qt.WindowStaysOnTopHint)
        self.videoWindow.label = QLabel(self.videoWindow)
        self.videoWindow.label.setFixedSize(280, 490)
        self.videoWindow.label.setStyleSheet("border: 5px solid #BBBBBB;")
        ...
        pos = qtg.QCursor().pos()
        next_x_position, next_y_position = self.check_if_on_screen(pos.x(), pos.y())
        self.videoWindow.move(next_x_position, next_y_position)
    ...
    def check_if_on_screen(self, x, y):
        ...
        if len(monitors) == 0:
            return 10, 10        
        for m in monitors:
            if x >= m[0] and m[0] + m[2] >= x + 295:
                if y >= m[1] and m[1] + m[3] >= y + 490:
                    return x + 15, y
                if y > 490:
                    return x + 15, y - 490
                else:
                    return x + 15, 0
        x_when_outside_monitor = x - 295
        y_when_outside_monitor = y - 490
        if x_when_outside_monitor < 0:
            x_when_outside_monitor = 0
        if y_when_outside_monitor < 0:
            y_when_outside_monitor = 0
        return x_when_outside_monitor, y_when_outside_monitor    
...
class MainWindow(QMainWindow):
    ...
    def setupUi(self, main_window):
        font_size11_no_bold_weight50 = QFont()
        font_size11_no_bold_weight50.setPointSize(11)
        font_size11_no_bold_weight50.setBold(False)
        font_size11_no_bold_weight50.setWeight(50)
        ...
        self.big_camera_label.setFixedSize(800, 600)
        ...
        self.refresh_cameras_button.setStyleSheet("""
                                                  QPushButton{
                                                  ...
                                                  QPushButton:pressed{background-color:#c3dff8;
                                                  border-style:outset;
                                                  border-radius:8px;
                                                  outline-color: black;
        ...
        self.modify_gestures_button.setStyleSheet("""
                                                  QPushButton{
                                                  background-color:white;
                                                  border-style:outset;
                                                  border-radius:8px;
        ...
        self.mouse_right_button_image_label = MyLabel(self.absolute_path, "mouse_right_click")
        ...
        font = font_size11_no_bold_weight50
        ...
        self.mouse_drag1_image_label = MyLabel(self.absolute_path, "mouse_drag")
        ...
        self.mouse_double_click1_image_label = MyLabel(self.absolute_path, "mouse_double_click")
        ...
        self.mouse_change_screen_image_label = MyLabel(self.absolute_path, "mouse_change_screen")
        ...
        self.mouse_left_button_image_label = MyLabel(self.absolute_path, "mouse_left_click")
        ...
        self.turning_hand_counter_image_label = MyLabel(self.absolute_path, "turning_hand_counterclockwise")
        ...
        self.mouse_exit_image_label = MyLabel(self.absolute_path, "mouse_stop")
        ...
        self.mouse_steering_image_label = MyLabel(self.absolute_path, "mouse_steering")
        ...
        self.thumb_up_image_label = MyLabel(self.absolute_path, "thumb_up")
        ...
        self.druming_fingers_image_label = MyLabel(self.absolute_path, "drumming_fingers")
        sizePolicy = QSizePolicy(
        ...
        self.swiping_up_image_label = MyLabel(self.absolute_path, "swiping_up")
        ...
        self.swiping_down_image_label = MyLabel(self.absolute_path, "swiping_down")
        ...
        self.rolling_hand_image_label = MyLabel(self.absolute_path, "rolling_hand_backward")
        ...
        self.swiping_left_image_label = MyLabel(self.absolute_path, "swiping_left")
        ...
        self.rolling_hand_forward_image_label = MyLabel(self.absolute_path, "rolling_hand_forward")
        ...
        self.swiping_right_image_label = MyLabel(self.absolute_path, "swiping_right")
        ...
        self.stop_sign_image_label = MyLabel(self.absolute_path, "stop_sign")
        ...
        self.thumb_down_image_label = MyLabel(self.absolute_path, "thumb_down")
        ...
        self.shaking_hand_image_label = MyLabel(self.absolute_path, "shaking_hand")
        ...
        self.zooming_out_with_fiull_hand_image_label = MyLabel(self.absolute_path, "zooming_out_with_full_hand")
        ...
        self.zooming_in_with_full_hand_image_label = MyLabel(self.absolute_path, "zooming_in_with_full_hand")
        ...
        self.zooming_in_with_two_fing_image_label = MyLabel(self.absolute_path, "zooming_in_with_two_fingers")
        ...
        self.zooming_out_with_two_fing_image_label = MyLabel(self.absolute_path, "zooming_out_with_two_fingers")
        ...
        self.turrning_hand_clock_image_label = MyLabel(self.absolute_path, "turning_hand_clockwise")
        ...
        self.pulling_hand_in_image_label = MyLabel(self.absolute_path, "pulling_hand_in")
        ...
        self.pushing_hand_away_image_label = MyLabel(self.absolute_path, "pushing_hand_away")
        ...
        self.pulling_two_fingers_image_label = MyLabel(self.absolute_path, "pulling_two_fingers_in")
        ...
        self.pushing_two_fingers_away_image_label = MyLabel(self.absolute_path, "pushing_two_fingers_away")
        ...
        self.sliding_two_fingers_left_image_label = MyLabel(self.absolute_path, "sliding_two_fingers_left")
        ...
        self.sliding_two_fingers_right_image_label = MyLabel(self.absolute_path, "sliding_two_fingers_right")
        ...
        self.sliding_two_fingers_down_image_label = MyLabel(self.absolute_path, "sliding_two_fingers_down")
        ...
        self.sliding_two_fingers_up_image_label = MyLabel(self.absolute_path, "sliding_two_fingers_up")
        ...
        self.restore_button.setMinimumSize(QSize(220, 40))
        font = QFont()
        font.setPointSize(11)
    ...
    def show_camera(self, is_checked):
        if self.minimized_camera_checkbox_disabled is False:
            if is_checked is True:
                ...
                if y_position < 0:
                    y_position = 0
                x_position, y_position = self.check_if_on_screen(x_position, y_position)
    ...
    def check_if_on_screen(self, x, y):
        ...
        for m in monitors:
            if x >= m[0] and y >= m[1] and m[0] + m[2] >= x + 320 and m[1] + m[3] >= y + 240:
                return x, y
        window_center_x = x + 160
        window_center_y = y + 120
        monitor_center_x = monitors[0][0] + monitors[0][2] / 2
        monitor_center_y = monitors[0][1] + monitors[0][3] / 2
        nearest_monitor_number = 0
        nearest_monitor_length = (window_center_x - monitor_center_x) ** 2 + (window_center_y - monitor_center_y) ** 2
        for i in range(1, len(monitors)):
            monitor_center_x = monitors[i][0] + monitors[i][2] / 2
            monitor_center_y = monitors[i][1] + monitors[i][3] / 2
            length = (window_center_x - monitor_center_x) ** 2 + (window_center_y - monitor_center_y) ** 2
            if length < nearest_monitor_length:
                nearest_monitor_length = length
                nearest_monitor_number = i       
        return monitors[nearest_monitor_number][0] + monitors[nearest_monitor_number][2] - 330, \
            monitors[nearest_monitor_number][1] + monitors[nearest_monitor_number][3] - 310
